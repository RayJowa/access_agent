                    ...
                    child: Container(
                      child: Column(
                        children: <Widget>[
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Center(
                                      child: Text(
                                        '${snapshot.data['commissionDue'].toString()}' ?? '0',
                                        style: TextStyle(
                                          fontSize: 45,
                                          fontWeight: FontWeight.w700,
                                          color: Color(0xFF094451),
                                    ...
                                    Center(
                                      child: Text(
                                        ...
                                        '\$${snapshot.data['monthCommission']!=null ? snapshot.data['monthCommission'].toString() : '0' }',
                                        style: TextStyle(
                                          fontSize: 20,
                                          color: Colors.grey[400],
                                        ),
                          ...
                          Container(
                            margin: EdgeInsets.symmetric(vertical:2.0 , horizontal: 14.0),

                            child: Row(
//                          crossAxisAlignment: CrossAxisAlignment.stretch,
                              children: <Widget>[
                                SmallBox('Policies',
                                    '${snapshot.data['activePolicies'] != null ? snapshot.data['activePolicies'].toString() : '0'}'
                                        '/${snapshot.data['totalPolicies'] != null ? snapshot.data['totalPolicies'].toString() : '0'}'),
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: ListTile(
                                                      leading: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            borderRadius: BorderRadius
                                                                .circular(5),
                                                            color: index < 2 ? Color(0xFF46737c) : Colors.grey[300]
                                                        ),
                                                        child: Icon(
                                                          Icons.mail_outline,
                                                          color: Colors.white,
                                                      ...
                                                      title: Text(
                                                        ...
                                                        style: TextStyle(
                                                            fontWeight: FontWeight.w700,
                                                            color: index < 2 ? Color(0xFF46737c) : Colors.grey[400]
                                                        ),
                                                                      ...
                                                                      children: <Widget>[
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: Row(
                                                                            children: <Widget>[
                                                                              Flexible(
                                                                                child: Text('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. In iaculis nunc sed augue lacus viverra.  ',
                                                                                  style: TextStyle(
                                                                                      height: 2,
                                                                                      fontSize: 20
                                                                                  ),
