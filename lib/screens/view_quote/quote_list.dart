...
import 'package:access_agent/screens/view_quote/quote_detail.dart';
...
class ViewQuoteListView extends StatefulWidget {

  final String surname;
  final String idNumber;
  final String agentID;

  ViewQuoteListView({this.surname, this.idNumber, this.agentID});


  @override
  _ViewQuoteListViewState createState() => _ViewQuoteListViewState();
}

class _ViewQuoteListViewState extends State<ViewQuoteListView> {
                              ...
                              itemBuilder: (context, index) {
                                 return ListTile(
                                   ...
                                   onTap: () {
                                     Navigator.push(
                                         context,
                                         MaterialPageRoute(builder: (BuildContext context) => QuoteDetailView(policy: policies[index],))
                                     );
                                   },
